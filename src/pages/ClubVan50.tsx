      ...
      <section className="relative min-h-[60vh] flex items-center justify-center section-navy">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-heading font-bold text-white mb-6">
            Club van 50
            <span className="block text-accent">Word Onderdeel van de Geschiedenis</span>
          </h1>
          
          <p className="text-xl text-heritage-foreground/80 max-w-3xl mx-auto leading-relaxed">
            Ter ere van ons 50-jarig jubileum lanceren we de exclusieve Club van 50. 
            Word onderdeel van deze mijlpaal en help onze club groeien naar de toekomst.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Als lid van de Club van 50 krijg je exclusieve voordelen en help je onze club 
          ...
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-heritage-foreground/80 text-lg">
                Vul onderstaand formulier in en we nemen contact met je op voor de details.
              </p>
            </div>
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20">
              <CardContent className="p-8">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="weergavenaam" className="text-white font-medium">
                    ...
                    <Input
                      ...
                      onChange={(e) => setFormData({...formData, weergavenaam: e.target.value})}
                      className="bg-white/20 border-white/30 text-white placeholder:text-white/60"
                      placeholder="Zoals je wilt verschijnen op het bord"
                    />
                    <p className="text-sm text-heritage-foreground/60">
                      Optioneel: Als je dit leeg laat, gebruiken we je volledige naam
                    </p>
                  </div>
