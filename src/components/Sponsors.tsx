  ...
  const sponsorBenefits = [
    {
      icon: Building2,
      title: "Zichtbaarheid",
      description: "Logo op shirts, website, en clubmateriaal voor maximale exposure"
    },
    {
      icon: Handshake,
      title: "Community",
      description: "Directe verbinding met een hechte lokale gemeenschap van rugbyliefhebbers"
    },
    {
      icon: Trophy,
      title: "Traditie",
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Als sponsor van Rugby Club de Scrumboks investeert u in meer dan alleen sport. 
            U steunt een gemeenschap, traditie en de ontwikkeling van jonge talenten in Tiel.
          </p>
        </div>
        
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {sponsorBenefits.map((benefit, index) => (
            <Card key={index} className="bg-white border-accent/10 shadow-warm hover-lift">
        ...
        <div className="bg-heritage rounded-3xl p-8 md:p-12 text-center">
          ...
          <p className="text-heritage-foreground/80 text-lg mb-8 max-w-2xl mx-auto">
            We zoeken bedrijven die net als wij geloven in teamwork, respect en groei. 
            Samen kunnen we nog meer bereiken voor onze club en gemeenschap.
          </p>
          
          <div className="grid sm:grid-cols-2 gap-6 max-w-lg mx-auto mb-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
              <div className="text-2xl font-heading font-bold text-accent">150+</div>
              <div className="text-sm text-heritage-foreground/80">Actieve Leden</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
              <div className="text-2xl font-heading font-bold text-accent">6</div>
              <div className="text-sm text-heritage-foreground/80">Teams Alle Leeftijden</div>
            </div>
          </div>
