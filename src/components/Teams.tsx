  ...
  const teams = [
    {
      ...
      description: "Onze hoofdmacht waar ervaren spelers en nieuwe talenten samen het veld betreden."
    },
    {
      name: "Dames",
      players: 20,
      age: "16+",
      training: "Di & Vr 20:00",
      description: "Sterke damesteam dat laat zien dat rugby voor iedereen toegankelijk is."
    },
    {
      name: "TBM",
      players: 53,
      ...
      description: "Onze jongste rugbyers leren hier de basis van rugby en teamwerk."
    },
    {
      name: "Cubs",
      players: 22,
      age: "12–14 jr",
      training: "Di & Do 18:45",
      description: "Ontwikkeling van techniek en tactiek staat centraal bij deze leeftijdsgroep."
    },
    {
      name: "Junioren",
      players: 18,
      age: "14–16 jr",
      training: "Di & Do 18:45",
      description: "Voorbereiding op seniorenrugby met focus op persoonlijke groei."
    },
    {
      name: "Colts",
      players: 16,
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-heritage-foreground/80 max-w-2xl mx-auto">
            Van 6 tot 60+, bij de Scrumboks is er een plek voor iedereen die van rugby houdt.
          </p>
        </div>
        
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {teams.map((team, index) => (
            <Card key={index} className="bg-white/95 border-none shadow-warm hover-lift group">
              <CardContent className="p-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 text-sm">
                    ...
                    <span className="font-semibold text-primary-navy">{team.players} spelers</span>
                  </div>
        ...
        <div className="text-center mt-12">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 max-w-2xl mx-auto">
            ...
            <p className="text-heritage-foreground/80 mb-6">
              Kom langs tijdens een training of neem contact met ons op. 
              Nieuwe leden zijn altijd welkom voor een proeftraining!
            </p>
            <div className="text-accent font-semibold">
              Trainingstijden: Di–Do 18:45–20:30, Vr 20:00–22:00
            </div>
          </div>
        </div>
      </div>
